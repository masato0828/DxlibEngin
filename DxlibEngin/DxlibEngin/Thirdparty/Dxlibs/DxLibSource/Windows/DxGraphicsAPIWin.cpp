...
static int Direct3DDevice9_ScalingSubBackbuffer( const RECT *SubBackBufferSrcRect )
{
	...
	if( GD3D9.Device.Screen.SubBackBufferTexture == NULL )
	{
		...
		if( ( GSYS.Screen.FullScreenScalingDestRect.right - GSYS.Screen.FullScreenScalingDestRect.left ) != ( DWORD )GD3D11.Device.Screen.SubBackBufferTextureSizeX ||
			( GSYS.Screen.FullScreenScalingDestRect.bottom - GSYS.Screen.FullScreenScalingDestRect.top ) != ( DWORD )GD3D11.Device.Screen.SubBackBufferTextureSizeY )
		{
			int                                   i ;
